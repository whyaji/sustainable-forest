...
import { Route } from '@/routes/_authenticated/data/patok-batas/$boundaryMarkerId/check-history/index.js';
...
export function CheckBmHistoryListScreen() {
  ...
  return (
    <TableData
      ...
      setLimit={setLimit}
      addUrl={`/data/patok-batas/${boundaryMarker.id}/check-history/add`}
      table={
        <FormCheckBmHistory
