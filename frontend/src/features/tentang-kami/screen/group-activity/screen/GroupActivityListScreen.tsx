...
import { Route } from '@/routes/_authenticated/tentang-kami/kelompok-komunitas/$kelompokKomunitasId/aktivitas';
...
export function GroupActivityListScreen() {
  ...
  return (
    <TableData
      ...
      addUrl={
        isCreator
          ? `/tentang-kami/kelompok-komunitas/${kelompokKomunitas.id}/aktivitas/add`
          : undefined
      }
