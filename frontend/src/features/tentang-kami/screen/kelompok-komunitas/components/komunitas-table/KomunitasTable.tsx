              ...
              <TableRow key={komunitas.id}>
                ...
                <TableCell className="flex flex-row gap-4">
                  <Button
                    ...
                    onClick={() =>
                      navigate({
                        to: `/tentang-kami/kelompok-komunitas/${komunitas.id}`,
                      })
                    }>
                  ...
                  {isActivityViewer && (
                    <Button
                      ...
                      onClick={() =>
                        navigate({
                          to: `/tentang-kami/kelompok-komunitas/${komunitas.id}/aktivitas`,
                        })
                      }>
                  ...
                  {(isEditor || (isEditorGroup && komunitas.id === user?.groupId)) && (
                    <Button
                      ...
                      onClick={() =>
                        navigate({
                          to: `/tentang-kami/kelompok-komunitas/${komunitas.id}/update-komunitas`,
                        })
                      }>
